...
contract('Wallet', (accounts) => {
  let wallet;
  //beforEach will run always before executing the it block of test
  beforeEach(async () => {
  ...
  it('should have correct approvers and quorum', async () => {
    ...
    //assertions are tests that run on data
  ...
  it('should NOT create transfers if sender is not approved', async () => {
    //testing error using helper function from openzepplen
    await expectRevert(
